...
fac_array.each do |c|
  ...
  5.times do
    ...
    Review.create( user_id: (1..9).to_a.sample, vendor_id: vendor.id, category_id: cat.id, review_content: "Ipsum lorem", review_private_content: "Lorem ipsum", rating: (1..5).to_a.sample)
  end
end
