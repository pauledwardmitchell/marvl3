...
class TestCategoryExpansionPanel extends React.Component {
  state = {
    expanded: null,
  };
...
TestCategoryExpansionPanel.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(TestCategoryExpansionPanel);
