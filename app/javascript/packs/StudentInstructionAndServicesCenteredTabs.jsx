...
class StudentInstructionAndServicesCenteredTabs extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      value: 0,
      ...
      <div className={classes.root}>
        <Grid container spacing={24} justify='center'>
          <Grid item xs={11}>
            ...
            {value === 4 && <TabContainer><CategoryExpansionPanel data={this.getCategories()}/></TabContainer>}
            {value === 5 && <TabContainer><CategoryExpansionPanel data={this.getCategories()}/></TabContainer>}
            {value === 6 && <TabContainer><CategoryExpansionPanel data={this.getCategories()}/></TabContainer>}
          </Grid>
        </Grid>
      </div>
    );
...
StudentInstructionAndServicesCenteredTabs.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(StudentInstructionAndServicesCenteredTabs);
